...
$stdout = Join-Path $validation "build-evidence\post-provenance-python-suite.stdout.log"
$stderr = Join-Path $validation "build-evidence\post-provenance-python-suite.stderr.log"
$exitFile = Join-Path $validation "build-evidence\post-provenance-python-suite.exit.txt"
$resultFile = Join-Path $validation "build-evidence\post-provenance-python-suite.result.txt"
