/**
 * @file warp_aggregation_smoke_test.cu
 * @brief Minimal standalone Warp aggregation verification program.
 *
 * Compile: nvcc -O2 -arch=sm_86 -o warp_aggregation_smoke_test warp_aggregation_smoke_test.cu
 */
