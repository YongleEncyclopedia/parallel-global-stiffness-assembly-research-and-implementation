...
- Existing visual artifacts under `results/` and `reports/`, excluding this redraw package: 287 files.
- Inventory split: `results/` 246 files; `reports/` 41 files.
- Redraw output: 9 Nature-style figures exported in 3 formats each, plus this manifest.
